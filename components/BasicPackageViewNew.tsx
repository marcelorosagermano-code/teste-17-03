...
export const BasicPackageViewNew = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-rose-500/30 pb-24 relative overflow-hidden">
      
      {/* Ambient Background Effects - NO NOISE */}
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-rose-600/10 rounded-full blur-[120px] animate-pulse duration-[4000ms]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-blue-600/10 rounded-full blur-[120px] animate-pulse duration-[5000ms]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <header className="mb-12 space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white via-zinc-200 to-zinc-600 leading-[0.9]">
            BIBLIOTECA
          </h1>
          ...
          <div className={`sticky top-4 z-40 transition-all duration-300 ${scrolled ? 'scale-95' : ''}`}>
            <div className="relative group max-w-2xl">
              ...
              <div className="relative bg-zinc-950/80 backdrop-blur-xl rounded-2xl border border-white/10 flex items-center p-2 shadow-2xl">
                <div className="pl-4 pr-3 text-zinc-500">
                  <Search size={20} />
                </div>
                <input
                  type="text"
                  className="flex-1 bg-transparent border-none text-white placeholder-zinc-600 focus:ring-0 focus:outline-none text-lg font-medium h-12"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredCategories.map((category, idx) => {
            ...
            return (
              <div 
                key={category.id}
                className="group relative h-[400px] sm:h-[450px] rounded-[2rem] overflow-hidden bg-zinc-900 border border-white/5 hover:border-white/20 transition-all duration-500 transform-gpu isolation-isolate"
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20 transform transition-transform duration-500">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-center mt-6 gap-3 opacity-80 group-hover:opacity-100 transition-opacity">
                      <div className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-zinc-800/50 border border-white/5 text-xs font-bold text-zinc-300 whitespace-nowrap">
                      ...
                      <button 
                        ...
                        className="px-8 py-3.5 rounded-full bg-white text-black flex items-center gap-2 hover:scale-105 active:scale-95 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:shadow-[0_0_30px_rgba(255,255,255,0.4)] cursor-pointer z-30"
                      >
        ...
        {filteredCategories.length === 0 && (
          <div className="min-h-[400px] flex flex-col items-center justify-center text-center p-8 border border-white/5 rounded-3xl bg-white/5 backdrop-blur-sm">
            <Aperture size={48} className="text-zinc-600 mb-4 animate-spin-slow" />
            <h3 className="text-2xl font-bold text-white mb-2">Dados não encontrados</h3>
